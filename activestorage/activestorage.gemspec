...
Gem::Specification.new do |s|
  ...
  s.metadata = {
    ...
    "changelog_uri"     => "https://github.com/jyoun-godaddy/activestorage/blob/v#{version}/activestorage/CHANGELOG.md",    "documentation_uri" => "https://api.rubyonrails.org/v#{version}/",
